...
<title>xcave Solution - Remover Comentário</title>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Voltar -->
			<form method="get" id="formVoltar" action="x_admin_2_comentarios.jsp">
				...
				<li class="nav-item active my-4"
					...
					style="cursor: pointer" class="nav-link"><i
						...
						style="font-size: 16px;">Voltar</span></a></li> <input
					style="visibility: hidden; width: 0;" type="text"
					value="<%=codigoPersonagem%>" name="codigo">
			</form>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<p>
									Tem certeza que deseja remover "<%=comentario%>"?
								</p>
							</div>
							<form method="post" action="removerComentario">
								<div class="modal-footer">
									<input style="visibility: hidden; width: 0;" type="text"
										value="<%=codigo%>" name="codigo" id="codigo">
									<button type="button" id="botaoRemoverComent"
		...
		<!-- JS Local -->
		<script src="js/removerComent.js"></script>
</body>
